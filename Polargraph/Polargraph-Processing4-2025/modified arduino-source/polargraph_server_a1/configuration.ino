...
AccelStepper motorA(8, A0,A1,A2,A3);  // Consecutive analog pins for bundled wiring
AccelStepper motorB(8, 8,9,10,11);    // Consecutive digital pins 8-11 for bundled wiring
#endif

// Invert motor directions to match controller simulation
extern void invertMotorA() {
  // Modified: Motor A is correct (false). Motor B reported wrong as true, so trying false.
  motorA.setPinsInverted(false, false, false);
  motorB.setPinsInverted(false, false, false);
}
